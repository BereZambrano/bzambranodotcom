...
/**
 * ProcessWire Pro Cache: Static cache clearing
 *
...
class ProCacheStaticClear extends ProCacheClass {
	...
	public function cacheMaintenance() {
		if($this->procache->noMaintenance) return 0;
		...
		if(is_file($maintenanceFile)) $this->files()->unlink($maintenanceFile);
