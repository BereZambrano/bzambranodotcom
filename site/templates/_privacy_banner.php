...
<div class="privacywire-wrapper bzambrano-privacy" id="privacywire-wrapper">
    <div class="privacywire-page-wrapper">
        <div class="privacywire privacywire-banner">
            ...
            <div class="privacywire-body">
                ...
                <div class="privacywire-buttons uk-grid-small uk-child-width-auto uk-grid" uk-grid>
                    <div>
                        <button class="uk-button uk-button-secondary uk-button-small allow-all" <?php echo (!$showAllButton) ? "hidden" : ""; ?>><?php echo $module->get("content_banner_button_allow_all{$module->lang}|content_banner_button_allow_all"); ?></button>
                    </div>
                    <div>
                        <button class="uk-button uk-button-secondary uk-button-small allow-necessary" <?php echo (!$showNecessaryButton) ? "hidden" : ""; ?>><?php echo $module->get("content_banner_button_allow_necessary{$module->lang}|content_banner_button_allow_necessary"); ?></button>
                    </div>

                    <div>
                        <button class="uk-button uk-button-secondary uk-button-small choose" <?php echo (!$showChooseButton) ? "hidden" : ""; ?>><?php echo $module->get("content_banner_button_choose{$module->lang}|content_banner_button_choose"); ?></button>
                    </div>
                </div>
        ...
        <div class="privacywire privacywire-options">
            ...
            <div class="privacywire-body">
                ...
                <div class="privacywire-buttons">
                    <button class="uk-button-secondary uk-button-small uk-button toggle" <?php echo ($showAllInsteadToggle) ? "hidden" : ""; ?>><?php echo $module->get("content_banner_button_toggle{$module->lang}|content_banner_button_toggle"); ?></button>
                    <button class="uk-button-secondary uk-button-small uk-button save"><?php echo $module->get("content_banner_button_save{$module->lang}|content_banner_button_save"); ?></button>
                    <button class="uk-button-secondary uk-button-small uk-button allow-all" <?php echo ($showAllInsteadToggle) ? "" : "hidden"; ?>><?php echo $module->get("content_banner_button_allow_all{$module->lang}|content_banner_button_allow_all"); ?></button>
                </div>
                <?php if (!empty($privacyPage) || !empty($imprintPage)): ?>
                    <div class="privacywire-page-links">
                        <?php if (!empty($privacyPage)): ?>
