...
?>
<div id="main-content" class="about-me uk-margin-remove-bottom" pw-append>
    <!-- First container -->
    <!-- Intro 1 -->
    ...
    <div class=" uk-margin-large-top">
        ...
        <!-- Intro 2-->
        <div class="uk-flex uk-margin-large uk-margin-large-top uk-flex-right">
            <div class="uk-flex uk-width-4-5@m uk-flex-wrap">
                <div class="uk-width-1-1">
                    <img class="uk-width-1-1"
                         src="<?= $page->about_pic2 ? $page->about_pic2->width(806)->height(537)->url : "" ?>">
                </div>
                <div class="default-paragraph uk-margin-small-top uk-text-left uk-width-1-1@m uk-margin-medium-bottom">
        ...
        <div class="uk-container uk-flex uk-flex-right">
            ...
            <div class="uk-flex uk-width-3-5@m uk-flex-wrap">
                ...
                <div class="">
                    ...
                    <!-- Service button -->
                    <div class="uk-width-1-1@m uk-margin-xlarge-bottom">
                        <a class="uk-button-primary uk-button" href="<?php echo $pages->get('template=servicios')->url; ?>">Services</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Second container-->
    <!--second text-->
    <div class="uk-container uk-container-large uk-background-secondary uk-light">
        <div class=" uk-margin-xlarge  uk-padding ">
            ...
            <div class="uk-flex uk-flex-right">
                <div class="text-column-wrapper uk-flex-center uk-flex-wrap">
                    <div class="uk-margin-remove-last-child listado-publicaciones">
                        ...
                        <div class="uk-margin-large-top">
                            <a class="uk-button-primary uk-button" href="<?php echo $pages->get('template=case-studies')->url; ?>">Case
                                Studies</a>
                            <div class="uk-margin-top uk-margin-large-bottom">
                                <a class="uk-button-primary uk-button" href="<?php echo $pages->get('template=portafolio')->url; ?>">Portfolio</a>
                            </div>
                        </div>
                    </div>
                </div>
